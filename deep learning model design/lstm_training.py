...
lstm_out = LSTM(16, return_sequences=False)(lstm_out)
lstm_out = Dropout(0.2)(lstm_out)
...
model_enhanced.compile(optimizer=Adam(learning_rate=0.001), loss='binary_crossentropy', metrics=['accuracy'])
# Save the model summary to a text file
with open('model_summary3.txt', 'w') as f:
...
model_checkpoint = ModelCheckpoint('best-perf-model.h5', save_best_only=True, monitor='val_loss', mode='min')
...
model_enhanced = load_model('best-perf-model.h5')
